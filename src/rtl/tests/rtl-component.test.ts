...
export interface RTLTestResults {
  ...
  accessibility: { screenReaderCompatible: boolean; keyboardNavigable: boolean };
}
...
export class RTLComponentTester {
  ...
  testComponent(componentElement: globalThis.HTMLElement, testSuite: RTLTestSuite): RTLTestResults {
    ...
    try {
      ...
      const results: RTLTestResults = {
        ...
        errors,
        warnings,
        performance: { renderTime: endTime - startTime, memoryUsage: this.estimateMemoryUsage() },
        accessibility,
      };
  ...
  private testRTLAccessibility(element: globalThis.HTMLElement): {
    ...
    return { screenReaderCompatible: hasAriaLabel, keyboardNavigable: isKeyboardNavigable };
  }
