...
export const Heading = forwardRef<HTMLHeadingElement, HeadingProps>(
  (
    ...
    const finalVisualSize = intentConfig.visualSize || visualSize || size || getDefaultVisualSize(finalLevel);
    const HeadingElement = getHeadingElement(finalLevel);
      ...
      <HeadingElement
        ...
        className={cn(
          headingVariants({
            ...
            display,
            truncate,
            marginBottom: intentConfig.marginBottom || marginBottom,
