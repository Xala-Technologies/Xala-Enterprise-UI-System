 ...
 */
export const XALA_INFO = { name: 'Xala Design System',
  version: XALA_VERSION,
  description: 'Enterprise-grade design system with WCAG AAA accessibility compliance',
  author: 'Xala Technologies',
  license: 'MIT',
  wcagCompliance: 'AAA',
  accessibility: { contrastRatio: '7:1 for normal text, 4.5:1 for large text',
 ...
 */
export const XALA_CATEGORIES = { FORM: 'Form Components',
  NAVIGATION: 'Navigation Components',
  FEEDBACK: 'Feedback Components',
  DATA_DISPLAY: 'Data Display Components',
  LAYOUT: 'Layout Components',
  OVERLAY: 'Overlay Components', } as const;

/**
 * Component registry for dynamic imports
 */
export const XALA_COMPONENTS = { // Form components
  Button: { name: 'Button',
