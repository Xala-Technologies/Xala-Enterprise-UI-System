 ...
 */
export const enhancedAccessibilityConfig: AccessibilityConfig = {
  level: 'WCAG_2_2_AAA',
  highContrast: true,
  reduceMotion: true,
  screenReader: true,
 ...
 */
export const minimalAccessibilityConfig: AccessibilityConfig = {
  level: 'none',
  highContrast: false,
  reduceMotion: false,
  screenReader: false,
 ...
 */
export function generateAccessibilityTokens(config: AccessibilityConfig): AccessibilityTokens {
  return {
    colors: {
      focus: config.highContrast ? '#0000ff' : '#005fcc',
      ...
      contrast: {
        text: config.highContrast ? '#000000' : '#212121',
    ...
    typography: {
      lineHeight: config.textSpacing.lineHeight.toString(),
    ...
    animation: {
      duration: config.reduceMotion ? '0ms' : `${config.animation.duration}ms`,
      timing: 'ease-in-out',
...
export function meetsContrastRequirements(
  ...
  const requirement = isLargeText ? config.colorContrast.large : config.colorContrast.normal;
...
export const accessibilityPresets = {
  none: minimalAccessibilityConfig,
  ...
  government: {
    ...
    custom: {
      ...enhancedAccessibilityConfig.custom,
      announcements: true,
      landmarks: true,
      skipLinks: true,
      breadcrumbs: true,
  ...
  enterprise: {
    ...
    custom: {
      ...defaultAccessibilityConfig.custom,
      announcements: true,
      landmarks: true,
      skipLinks: true,
      breadcrumbs: false,
