...
export interface LayoutComponentProps extends ComponentProps { padding?: 'none' | 'sm' | 'md' | 'lg' | 'xl';
  margin?: 'none' | 'sm' | 'md' | 'lg' | 'xl' | 'auto';
  background?: 'primary' | 'secondary' | 'tertiary' | 'transparent'; }

// PageLayout props - top-level page structure
export interface PageLayoutProps extends LayoutComponentProps { header?: ReactNode;
  footer?: ReactNode;
  sidebar?: ReactNode;
...
export interface SectionProps extends LayoutComponentProps { as?: 'section' | 'article' | 'aside' | 'nav' | 'header' | 'footer' | 'main';
  variant?: 'primary' | 'secondary' | 'accent' | 'neutral';
  spacing?: 'none' | 'sm' | 'md' | 'lg' | 'xl'; }

// Container props - content containers with Norwegian standards
export interface ContainerProps extends LayoutComponentProps { size?: 'sm' | 'md' | 'lg' | 'xl' | 'full';
  center?: boolean;
  ...
  norwegian?: { maxWidth?: boolean; // Follow Norwegian content width guidelines
    accessibility?: boolean; // WCAG 2.2 AA spacing }; }

// Grid props - CSS Grid layout
export interface GridProps extends LayoutComponentProps { columns?: number | 'auto' | 'fit';
  rows?: number | 'auto';
...
export interface StackProps extends LayoutComponentProps { direction?: 'row' | 'column';
  gap?: 'none' | 'sm' | 'md' | 'lg' | 'xl';
  align?: 'start' | 'center' | 'end' | 'stretch';
...
export interface CardProps extends LayoutComponentProps { variant?: 'default' | 'outlined' | 'elevated' | 'government' | 'municipal';
...
export interface NorwegianLayoutProps { language?: 'nb' | 'nn' | 'en';
  municipality?: 'drammen' | 'oslo' | 'bergen' | 'trondheim' | 'stavanger';
  accessibility?: 'WCAG_2_2_AA' | 'WCAG_2_2_AAA';
  classification?: 'ÅPEN' | 'BEGRENSET' | 'KONFIDENSIELT' | 'HEMMELIG'; }

// Responsive breakpoint types
export interface ResponsiveProps<T = unknown> { mobile?: T;
  tablet?: T;
  desktop?: T;
  wide?: T; }

// CSS-in-JS style object type for design tokens
export interface TokenizedStyles { [key: string]: string | number | TokenizedStyles; }
